...
class LinkedList:
    ...
    ## CC 08
    @staticmethod
    def linkedListZip(list_a: 'LinkedList', list_b: 'LinkedList'):
        """
        Zip two linked lists together.

        Args:
            list_a (LinkedList): The first linked list.
            list_b (LinkedList): The second linked list.
